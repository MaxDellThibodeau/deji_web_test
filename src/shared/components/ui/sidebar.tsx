...
const navigation = [
  ...
  { name: "Token Bidding", href: "/token-bidding", icon: Coins },
    ...
    <SidebarProvider>
      <Sidebar className="bg-black/80 backdrop-blur-sm border-r border-zinc-800/50">
        ...
        <SidebarFooter className="p-4">
          <div className="flex items-center space-x-3 rounded-md bg-zinc-800/50 border border-zinc-700/50 p-3">
            <User className="h-5 w-5 text-purple-400" />
            <div>
              <p className="text-sm font-medium">Max123</p>
              <p className="text-xs text-zinc-400">Attendee</p>
            </div>
          </div>
        </SidebarFooter>
      </Sidebar>
...
export function MobileNav() {
  ...
  return (
    <div className="md:hidden">
      ...
      {open && (
        <div className="fixed inset-0 top-[73px] z-50 bg-black/95 backdrop-blur-sm">
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={cn(
                  ...
                  pathname === item.href
                    ? "bg-gradient-to-r from-purple-600/20 to-blue-500/20 border border-purple-500/20 text-white"
